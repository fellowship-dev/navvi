 ...
 * - `artifacts.ts` — U5: the plain command's `--work`, the same artifacts
 *                  written from a compile the crawler ran.
...
export { AnswerError, answersFromUrls, applyAnswers, matchAnswer, parseAnswer, stillBlocking, type Answer, type AppliedAnswers, type FieldTypes, type MatchedAnswer } from "./answers.js";
export { writeCompiledTemplate, type AbsentArtifact, type WrittenArtifacts } from "./artifacts.js";
...
export { CAPTURE_LIMIT, SETTLE_CAP_MS, openPages, plainFetch, type DrivenCapture, type Pages, type PagesOptions, type Settle, type SettleTrend } from "./pages.js";
